...
// ============================================================
// CINAF v2 — Création d'un film (studio)
// Formulaire minimal pour créer un brouillon, redirection
// ensuite vers la page d'édition pour ajouter poster + vidéo.
// ============================================================
...
export default function NewFilmPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    setSubmitting(true);
    try {
      const created = await studioFilms.create({
        title: title.trim(),
        synopsis: synopsis.trim(),
        year,
        duration,
      });
      router.push(`/studio/films/${created.id}/edit`);
    } catch (err: unknown) {
    ...
    <div>
      ...
      >
        ...
        <div>
          ...
          <div className="small mt-1" style={{ color: "var(--cinaf-text-muted)" }}>
            ...
            uploader l&apos;affiche (max 10 Mo) et la vidéo (max 3 Go), puis publier.
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div className="row g-3 mb-3">
          ...
          <div className="col-12 col-md-6">
            <label htmlFor="duration" className="form-label" style={{ color: "var(--cinaf-text)" }}>
              Durée (minutes) <span style={{ color: "#ff8a8a" }}>*</span>
            </label>
            <input
              id="duration"
              type="number"
        ...
        <div className="d-flex gap-2">
          ...
          <Link href="/studio/films" className="btn btn-secondary">
            Annuler
          </Link>
        </div>
      </form>
